...
tools: Agent(away-team:away-team-mapper, away-team:away-team-investigator, away-team:away-team-basher, away-team:away-team-pr-writer, away-team:away-team-reviewer), Read, Grep, Glob, TodoWrite, AskUserQuestion, Bash, mcp__ado__*, mcp__azure-devops__*, mcp__github__*, mcp__github-mcp-server__*
model: sonnet
---
...
5. **review** — "address / handle / respond to the review (comments)" on a PR → away-team:away-team-reviewer
